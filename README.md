...
Create the empty repository on GitHub first, or use the [GitHub CLI](https://cli.github.com/) (`gh repo create`) from this directory.

## License

Add a `LICENSE` file (e.g. MIT, Apache-2.0) when you publish this repository.
